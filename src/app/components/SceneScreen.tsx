    ...
    <div className="min-h-screen bg-black">
      ...
      <header className="px-6 py-5 border-b border-white/10 sticky top-0 bg-black/95 backdrop-blur-sm z-10">
        <div className="flex items-center gap-4">
          ...
          <h1 className="font-['Playfair_Display'] text-lg tracking-wide">Scene & Context</h1>
        </div>
      </header>
      ...
      <div className="px-6 py-8 space-y-8 pb-12">
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h2 className="font-['Playfair_Display'] text-xl">Historical Context</h2>
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h2 className="font-['Playfair_Display'] text-xl">The Three Panels</h2>
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h2 className="font-['Playfair_Display'] text-xl">Key Symbolism</h2>
          <div className="space-y-3">
            <SymbolCard
        ...
        <motion.div
          ...
          className="p-5 bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-lg space-y-3"
        >
          <h3 className="font-['Playfair_Display'] text-base">Modern Interpretation</h3>
...
function SymbolCard({ title, meaning }: { title: string; meaning: string }) {
  return (
    <div className="flex gap-4 p-4 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-colors">
      <div className="flex-shrink-0 w-2 h-2 rounded-full bg-white/40 mt-1.5" />
      <div className="flex-1 space-y-1">
        <h4 className="text-sm font-['Playfair_Display']">{title}</h4>
