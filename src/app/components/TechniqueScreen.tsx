    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="px-6 py-5 border-b border-border sticky top-0 bg-background/95 backdrop-blur-sm z-10">
        <div className="flex items-center gap-4">
          ...
          <h1 className="font-['Inter'] font-bold text-lg tracking-tight">Technique & Materials</h1>
        </div>
      </header>
      ...
      <div className="px-6 py-8 space-y-8 pb-12">
        ...
        <motion.div
          ...
          className="relative h-56 rounded-lg overflow-hidden border border-border"
        >
          <img
          ...
          <div className="absolute bottom-4 left-4 right-4">
            <p className="text-xs text-white/90">Detail showing brushwork and layering technique</p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h2 className="font-['Inter'] font-bold text-xl">Materials Used</h2>
            ...
            {materials.map((material, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-['Inter'] font-semibold mb-1">{material.label}</h3>
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h2 className="font-['Inter'] font-bold text-xl">Painting Process</h2>
          <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            <div className="space-y-3">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-['Inter'] font-semibold text-foreground mb-1">Gesso Preparation</h4>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-['Inter'] font-semibold text-foreground mb-1">Underdrawing</h4>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-['Inter'] font-semibold text-foreground mb-1">Layered Painting</h4>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-['Inter'] font-semibold text-foreground mb-1">Fine Details</h4>
        ...
        <motion.div
          ...
          className="p-5 bg-gradient-to-br from-accent to-background border border-border rounded-lg"
        >
          <h3 className="font-['Inter'] font-bold text-base mb-3">Innovation & Mastery</h3>
